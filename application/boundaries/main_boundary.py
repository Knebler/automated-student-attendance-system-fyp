...
from application.controls.auth_control import AuthControl  # Import AuthControl
...
def submit_testimonial():
    ...
    if request.method == 'POST':
        # Use AuthControl to verify session
        auth_result = AuthControl.verify_session(current_app, flask_session)
        
        if not auth_result['success']:
            flash('Please log in to submit a testimonial', 'error')
